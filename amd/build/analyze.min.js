...
/**
   ...
   */Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.init=void 0,_seord=_interopRequireDefault(_seord),_jquery=_interopRequireDefault(_jquery),_templates=_interopRequireDefault(_templates);_exports.init=function(){let publicPage=!(arguments.length>0&&void 0!==arguments[0])||arguments[0],redirected=arguments.length>1&&void 0!==arguments[1]&&arguments[1],pageUrl=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"",keywords=arguments.length>3&&void 0!==arguments[3]?arguments[3]:[];(0,_jquery.default)((async function(){var _keywords$shift,_document$querySelect2;let toogelTimeout,info="Public: ";if(info+=publicPage?"yes":"no",info+="\nRedirected: ",info+=redirected?"yes":"no",info+="\nPage URL: ",info+=pageUrl,console.log(info),(0,_jquery.default)(".seo-manager-footer__toggle").on("click",(function(){clearTimeout(toogelTimeout),(0,_jquery.default)(".seo-manager-footer__content").slideToggle(),toogelTimeout=setTimeout((()=>{let isVisible=(0,_jquery.default)(".seo-manager-footer__content").is(":visible");(0,_jquery.default)(this).html(isVisible?"&times;":"&#9650;")}),500)})),!publicPage||redirected)return;var _document$querySelect;0==keywords.length&&(keywords=(null===(_document$querySelect=document.querySelector("meta[name='keywords']"))||void 0===_document$querySelect?void 0:_document$querySelect.content)||"",keywords=keywords.split(",").map((value=>value.trim())));const contentJson={title:document.title||"Untitled Page",htmlText:(0,_jquery.default)('[data-purpose="seo-page-content"]').html(),keyword:null!==(_keywords$shift=keywords.shift())&&void 0!==_keywords$shift?_keywords$shift:"",subKeywords:keywords,metaDescription:(null===(_document$querySelect2=document.querySelector("meta[name='description']"))||void 0===_document$querySelect2?void 0:_document$querySelect2.content)||"",languageCode:M.cfg.language};let checker=new _seord.default(contentJson,window.location.hostname,!0),result=await checker.analyzeSeo();console.log("SEO Analysis Report:",result);let context={seoscore:result.seoScore,wordcount:result.wordCount,keywordseoscore:result.keywordSeoScore,keyworddensity:result.keywordDensity,keywordfrequency:result.keywordFrequency,pagetitle:contentJson.title,metadescription:contentJson.metaDescription,keyword:contentJson.keyword,subkeywords:contentJson.subKeywords.join(", "),titlewordcount:result.titleSEO.wordCount,titlekeyworddensity:result.titleSEO.keywordWithTitle.density,titlekeywordposition:result.titleSEO.keywordWithTitle.position,titlekeyword:result.titleSEO.keywordWithTitle.keyword,subkeywordswithtitle:result.titleSEO.subKeywordsWithTitle,warning:result.messages.warnings,goodpoints:result.messages.goodPoints,minorwarnings:result.messages.minorWarnings,totallinks:result.totalLinks,internallinkscount:result.internalLinks.all.length,uniqueinternallinkscount:result.internalLinks.unique.length,duplicateinternallinkscount:result.internalLinks.duplicate.length,uniqueinternallinks:result.internalLinks.unique,duplicateinternallinks:result.internalLinks.duplicate,externallinkscount:result.outboundLinks.all.length,uniqueexternallinkscount:result.outboundLinks.unique.length,duplicateexternallinkscount:result.outboundLinks.duplicate.length,uniqueexternallinks:result.outboundLinks.unique,duplicateexternallinks:result.outboundLinks.duplicate},html=await _templates.default.render("theme_seo/seo-info",context);(0,_jquery.default)(".seo-info-details").html(html)}))}}));
